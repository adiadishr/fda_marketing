...
import { filters, products } from '@/constants';
            ...
            <div className="container px-4 py-24 mx-auto md:py-32">
                ...
                <section className="pt-10">
                    <div className="relative grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                        {/* Filters */}
                        <form className="hidden lg:block z-10 sticky top-24 h-[calc(100vh-120px)] overflow-y-scroll">
                            <div className="sticky top-0 w-full pb-6 text-lg font-medium border-b text-neutral-900 bg-neutral-50">Filters</div>
                            {filters.map((section) => (
                                <Disclosure key={section.id} as="div" className="py-6 pr-6 border-b border-gray-200" defaultOpen={true}>
                            ...
                            <div className="grid grid-cols-2 gap-x-6 gap-y-10 lg:grid-cols-3 xl:gap-x-8">
                                {products.map((product, idx) => (
                                    <div key={idx} className="relative group ">
                                        <div className="relative overflow-hidden rounded-md aspect-square group lg:aspect-auto lg:h-80">
                                            <Image
                                                fill
                                            ...
                                            />
                                            <div className='absolute inset-0 z-30 w-full h-full duration-500 translate-y-full bg-gradient-to-t from-black/75 via-black/50 to-black/25 group-hover:translate-y-0' />
                                            <Plus strokeWidth={1} size={40} className='absolute z-40 duration-500 translate-x-1/2 -translate-y-1/2 opacity-0 text-neutral-100 top-1/2 right-1/2 group-hover:opacity-100' />
                                        </div>
                                        <div className="flex justify-between mt-4">
                                            <div>
                                                <h3 className="text-gray-900">
                                                    <Link href={`/catalog/${product.href}`}>
                                                        <span aria-hidden="true" className="absolute inset-0 z-50" />
                                                        {product.name}
                                                    </Link>
                                                </h3>
                                            </div>
